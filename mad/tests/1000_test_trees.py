...
from mad.optimize import dfs_goal_allocation, agent_goal_m, cost_node, optimized_goal_allocation, count_total_goals, extract_goalnodes_dict
import random as r
