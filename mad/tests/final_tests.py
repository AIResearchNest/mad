...
def four_layer_binary_left(num_agents, random=False) -> [GoalNode, GoalNode2]:
    ...
    if random:
        root_agents = _random_cost(25, 45, num_agents)
        subgoal1_agents = _random_cost(10, 15, num_agents)
        subgoal2_agents = _random_cost(10, 15, num_agents)
        subgoal3_agents = _random_cost(5, 10, num_agents)
        subgoal4_agents = _random_cost(5, 10, num_agents)
        subgoal5_agents = _random_cost(1, 5, num_agents)
        subgoal6_agents = _random_cost(1, 5, num_agents)
    else:
        root_agents = _equal_cost(25, 45, num_agents)
        subgoal1_agents = _equal_cost(10, 15, num_agents)
        subgoal2_agents = _equal_cost(10, 15, num_agents)
        subgoal3_agents = _equal_cost(5, 10, num_agents)
        subgoal4_agents = _equal_cost(5, 10, num_agents)
        subgoal5_agents = _equal_cost(1, 5, num_agents)
        subgoal6_agents = _equal_cost(1, 5, num_agents)
...
def six_layer_binary_left(num_agents, random=False) -> [GoalNode, GoalNode2]:
    ...
    """
    if random:
        root_agents = _random_cost(110, 150, num_agents)
        subgoal1_agents = _random_cost(53, 70, num_agents)
        subgoal2_agents = _random_cost(53, 70, num_agents)
        subgoal3_agents = _random_cost(29, 40, num_agents)
        subgoal4_agents = _random_cost(29, 40, num_agents)
        subgoal5_agents = _random_cost(12, 18, num_agents)
        subgoal6_agents = _random_cost(12, 18, num_agents)
        subgoal7_agents = _random_cost(12, 18, num_agents)
        subgoal8_agents = _random_cost(12, 18, num_agents)
        subgoal9_agents = _random_cost(4, 8, num_agents)
        subgoal10_agents = _random_cost(4, 8, num_agents)
        subgoal11_agents = _random_cost(4, 8, num_agents)
        subgoal12_agents = _random_cost(4, 8, num_agents)
        subgoal13_agents = _random_cost(4, 8, num_agents)
        subgoal14_agents = _random_cost(4, 8, num_agents)
        subgoal15_agents = _random_cost(4, 8, num_agents)
        subgoal16_agents = _random_cost(4, 8, num_agents)
        subgoal17_agents = _random_cost(1, 3, num_agents)
        subgoal18_agents = _random_cost(1, 3, num_agents)
        subgoal19_agents = _random_cost(1, 3, num_agents)
        subgoal20_agents = _random_cost(1, 3, num_agents)
        ...
        root_agents = _equal_cost(110, 150, num_agents)
        subgoal1_agents = _equal_cost(53, 70, num_agents)
        subgoal2_agents = _equal_cost(53, 70, num_agents)
        subgoal3_agents = _equal_cost(29, 40, num_agents)
        subgoal4_agents = _equal_cost(29, 40, num_agents)
        subgoal5_agents = _equal_cost(12, 18, num_agents)
        subgoal6_agents = _equal_cost(12, 18, num_agents)
        subgoal7_agents = _equal_cost(12, 18, num_agents)
        subgoal8_agents = _equal_cost(12, 18, num_agents)
        subgoal9_agents = _equal_cost(4, 8, num_agents)
        subgoal10_agents = _equal_cost(4, 8, num_agents)
        subgoal11_agents = _equal_cost(4, 8, num_agents)
        subgoal12_agents = _equal_cost(4, 8, num_agents)
        subgoal13_agents = _equal_cost(4, 8, num_agents)
        subgoal14_agents = _equal_cost(4, 8, num_agents)
        subgoal15_agents = _equal_cost(4, 8, num_agents)
        subgoal16_agents = _equal_cost(4, 8, num_agents)
        subgoal17_agents = _equal_cost(1, 3, num_agents)
        subgoal18_agents = _equal_cost(1, 3, num_agents)
        subgoal19_agents = _equal_cost(1, 3, num_agents)
        subgoal20_agents = _equal_cost(1, 3, num_agents)
...
# print_goal_tree(six_layer_binary_right(3, {'grace': 50, 'remus': 50, 'franklin': 50})[0])
# print_goal_tree_m(six_layer_binary_right(3, [50,50,50])[1])
