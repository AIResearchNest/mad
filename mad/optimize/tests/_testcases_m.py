...
def random_binary_symetric_s():
    ...
    root = GoalNode("Main Goal", random_cost_m(35,45))
    subgoal1 = GoalNode("Sub Goal 1", random_cost_m(15,25))
    subgoal2 = GoalNode("Sub Goal 2", random_cost_m(15,25))
    subgoal3 = GoalNode("Sub Goal 3", random_cost_m(5,15))
    subgoal4 = GoalNode("Sub Goal 4", random_cost_m(5,15))
    subgoal5 = GoalNode("Sub Goal 5", random_cost_m(5,15))
    subgoal6 = GoalNode("Sub Goal 6", random_cost_m(5,15))
...
def random_binary_left_s():
    ...
    root = GoalNode("Main Goal", random_cost_m(25,35))
    subgoal1 = GoalNode("Sub Goal 1", random_cost_m(15,25))
    subgoal2 = GoalNode("Sub Goal 2", random_cost_m(15,25))
    subgoal3 = GoalNode("Sub Goal 3", random_cost_m(5,15))
    subgoal4 = GoalNode("Sub Goal 4", random_cost_m(5,15))
...
def random_root_s():
    ...
    root = root = GoalNode("Main Goal", random_cost_m(25,35))
...
def random_tree_symetric_s():
    ...
    subgoal1 = GoalNode("Sub Goal 1", random_cost_m(15,25))
    subgoal2 = GoalNode("Sub Goal 2", random_cost_m(15,25))
    subgoal3 = GoalNode("Sub Goal 3", random_cost_m(15,25))
    subgoal4 = GoalNode("Sub Goal 4", random_cost_m(5,15))
    subgoal5 = GoalNode("Sub Goal 5", random_cost_m(5,15))
    subgoal6 = GoalNode("Sub Goal 6", random_cost_m(5,15))
    subgoal7 = GoalNode("Sub Goal 7", random_cost_m(5,15))
    subgoal8 = GoalNode("Sub Goal 8", random_cost_m(5,15))
    subgoal9 = GoalNode("Sub Goal 9", random_cost_m(5,15))
    subgoal10 = GoalNode("Sub Goal 10", random_cost_m(5,15))
    subgoal11 = GoalNode("Sub Goal 11", random_cost_m(5,15))
    subgoal12 = GoalNode("Sub Goal 12", random_cost_m(5,15))
    root.add_child(subgoal1)
    root.add_child(subgoal2)
...
def random_large_tree_s():
    ...
    x = 30
    y = 60
    root = GoalNode("Main Goal", random_cost_m(x,y))
    
    x = 23
    y = 30
    subgoal1 = GoalNode("Sub Goal 1", random_cost_m(x,y))
    subgoal2 = GoalNode("Sub Goal 2", random_cost_m(x,y))
    
    x = 10
    y = 20
    subgoal3 = GoalNode("Sub Goal 3", random_cost_m(x,y))
    subgoal4 = GoalNode("Sub Goal 4", random_cost_m(x,y))
    subgoal5 = GoalNode("Sub Goal 5", random_cost_m(x,y))
    subgoal6 = GoalNode("Sub Goal 6", random_cost_m(x,y))
    x = 5
    y = 10
    subgoal7 = GoalNode("Sub Goal 7", random_cost_m(x,y))
    subgoal8 = GoalNode("Sub Goal 8", random_cost_m(x,y))
    subgoal9 = GoalNode("Sub Goal 9", random_cost_m(x,y))
    subgoal10 = GoalNode("Sub Goal 10", random_cost_m(x,y))
    subgoal11 = GoalNode("Sub Goal 11", random_cost_m(x,y))
    subgoal12 = GoalNode("Sub Goal 12", random_cost_m(x,y))
    subgoal13 = GoalNode("Sub Goal 13", random_cost_m(x,y))
    subgoal14 = GoalNode("Sub Goal 14", random_cost_m(x,y))

    x = 3
    y = 6
    subgoal15 = GoalNode("Sub Goal 15", random_cost_m(x,y))
    subgoal16 = GoalNode("Sub Goal 16", random_cost_m(x,y))
    subgoal17 = GoalNode("Sub Goal 17", random_cost_m(x,y))
    subgoal18 = GoalNode("Sub Goal 18", random_cost_m(x,y))
    subgoal19 = GoalNode("Sub Goal 19", random_cost_m(x,y))
    subgoal20 = GoalNode("Sub Goal 20", random_cost_m(x,y))
    subgoal21 = GoalNode("Sub Goal 21", random_cost_m(x,y))
    subgoal22 = GoalNode("Sub Goal 22", random_cost_m(x,y))
    subgoal23 = GoalNode("Sub Goal 23", random_cost_m(x,y))
    subgoal24 = GoalNode("Sub Goal 24", random_cost_m(x,y))
    subgoal25 = GoalNode("Sub Goal 25", random_cost_m(x,y))
    subgoal26 = GoalNode("Sub Goal 26", random_cost_m(x,y))
    subgoal27 = GoalNode("Sub Goal 27", random_cost_m(x,y))
    subgoal28 = GoalNode("Sub Goal 28", random_cost_m(x,y))
    subgoal29 = GoalNode("Sub Goal 29", random_cost_m(x,y))
    subgoal30 = GoalNode("Sub Goal 30", random_cost_m(x,y))
